...
namespace Charlotte
{
	public class ResourceMusic
	{
		...
		public DDMusic Boss_01 = new DDMusic(@"dat\ユーフルカ\Battle-Vampire_loop\Battle-Vampire_loop.ogg").SetLoop(241468, 4205876);
		public DDMusic Boss_02 = new DDMusic(@"dat\ユーフルカ\Battle-Conflict_loop\Battle-Conflict_loop.ogg").SetLoop(281888, 3704134);
		public DDMusic Boss_03 = new DDMusic(@"dat\ユーフルカ\Battle-rapier_loop\Battle-rapier_loop.ogg").SetLoop(422312, 2767055);
