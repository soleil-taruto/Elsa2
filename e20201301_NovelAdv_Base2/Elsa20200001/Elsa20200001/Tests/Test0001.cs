		...
		public void Test01()
		{
			for (; ; )
			{
				...
				// 選択項目 x3
				{
					...
					DDDraw.DrawSimple(Ground.I.Picture.MessageFrame_Button2, x, y + yStep * 0);
					DDDraw.DrawSimple(Ground.I.Picture.MessageFrame_Button2, x, y + yStep * 1);
					DDDraw.DrawSimple(Ground.I.Picture.MessageFrame_Button2, x, y + yStep * 2);
		...
		public void Test02()
		{
			for (; ; )
			{
				...
				// 選択項目 x2 / 枠 x3
				{
					...
					DDDraw.DrawSimple(Ground.I.Picture.MessageFrame_Button2, x, y + yStep * 0);
					DDDraw.DrawSimple(Ground.I.Picture.MessageFrame_Button2, x, y + yStep * 1);
					DDDraw.DrawSimple(Ground.I.Picture.MessageFrame_Button, x, y + yStep * 2);
